...
public class CreateBookingDetailService {
	...
	public BookingDetailsReturn createBookingDetail(BookingDetails bookingDetails) {
		...
		createCustomerService.createCustomer(bookingDetails.getC(), r,bookingDetails.getCategoryType());
		bookingDetailsRepository.save(bookingDetails);
		return createEntity1(r, bookingDetails);
	}
...
//		Long getTime = getTimeDateDiffrence( startDate, endDate);
//		if()
//		int total = 0;
